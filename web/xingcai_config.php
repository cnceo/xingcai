...
/*		数据库配置		*/
$conf['db']['dsn']='mysql:host=localhost;dbname=admin;charset=utf8';
$dbname='admin';
$dbhost='localhost';
$conf['db']['user']='root';
...
<?php
error_reporting(0);
$config = mysql_connect("localhost","root","root")or die("Mysql Connect Error");//设置数据库IP，账号，密码
mysql_select_db("admin");//数据库库名
